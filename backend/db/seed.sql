...
-- Insert trimesters (Global)
INSERT INTO trimesters (name, start_date, end_date) VALUES
('Trimester 1 2026', '2026-03-02', '2026-06-19'),
('Trimester 2 2026', '2026-07-13', '2026-10-30');
...
INSERT INTO units (name, code, degree_id, classroom_type, total_students, class_duration) VALUES
('Introduction to Programming', 'ICT100', (SELECT id FROM degrees WHERE code = 'BCS'), 'lab', 60, 2),
('Data Structures', 'ICT200', (SELECT id FROM degrees WHERE code = 'BCS'), 'normal', 45, 2),
('Database Systems', 'ICT210', (SELECT id FROM degrees WHERE code = 'BCS'), 'lab', 50, 2),
('Web Development', 'ICT220', (SELECT id FROM degrees WHERE code = 'BCS'), 'lab', 70, 2),
('Advanced Algorithms', 'ICT300', (SELECT id FROM degrees WHERE code = 'BCS'), 'normal', 30, 1),
('Machine Learning', 'ICT400', (SELECT id FROM degrees WHERE code = 'ICT-MSC'), 'lab', 25, 3);

-- Assign units to trimesters
INSERT INTO unit_trimesters (unit_id, trimester_id) VALUES
((SELECT id FROM units WHERE code = 'ICT100'), (SELECT id FROM trimesters WHERE name = 'Trimester 1 2026' LIMIT 1)),
((SELECT id FROM units WHERE code = 'ICT200'), (SELECT id FROM trimesters WHERE name = 'Trimester 1 2026' LIMIT 1)),
((SELECT id FROM units WHERE code = 'ICT210'), (SELECT id FROM trimesters WHERE name = 'Trimester 1 2026' LIMIT 1)),
((SELECT id FROM units WHERE code = 'ICT220'), (SELECT id FROM trimesters WHERE name = 'Trimester 1 2026' LIMIT 1)),
((SELECT id FROM units WHERE code = 'ICT300'), (SELECT id FROM trimesters WHERE name = 'Trimester 1 2026' LIMIT 1)),
((SELECT id FROM units WHERE code = 'ICT400'), (SELECT id FROM trimesters WHERE name = 'Trimester 1 2026' LIMIT 1));
